...
matching in $V\backslash V\left(H\right)$ containing each of the
vertices violating the second condition. There are $n'=n-v\left(H\right)-\delta n\ge\left(1-2\delta\right)n$
...
$L$ (with tripartition $V=V_{1}\sqcup V_{2}\sqcup V_{3}$) satisfying
the following properties for some $\delta=\delta\left(n\right)=o\left(1\right)$
and fixed $\beta>0$.
\begin{enumerate}
