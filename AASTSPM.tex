...
Let $h\ge2$ be as in \ref{thm:keevash}. Let $c=a\,b\left(a,h\right)$
in the notation of \ref{lem:triangle-removal-analysis}, let $\varepsilon=n^{-c}$
and let $M=\left(1-\varepsilon\right)N$. Let $\randS^{*}\supseteq S$
...
$S$. By \ref{prop:H-count}, for each $S^{*}\in\ord^{*}$, the number
of triangles in each $G\left(S_{i}^{*}\right)$ is $\left(1\pm O\left(n^{-c}\right)\right)\left(1-i/N\right)^{3}n^{3}/6$
...
\left|\ord^{*}\right| & \ge\left(1-o\left(1\right)\right)\prod_{i=\alpha N}^{M-1}\left(1-O\left(n^{-c}\right)\right)\left(1-\frac{i}{N}\right)^{3}n^{3}/6.\\
 & =\left(\left(1-O\left(n^{-c}\right)\right)\frac{n^{3}}{6}\right)^{\left(1-\alpha\right)N}\exp\left(3N\sum_{i=\alpha N}^{M-1}\frac{1}{N}\log\left(1-\frac{i}{N}\right)\right).
\end{align*}
Now, note that 
\[
