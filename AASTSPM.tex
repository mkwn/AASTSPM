...
\Delta p^{k}\left(i\right) & =\left(1-\frac{i+1}{N}\right)^{k}-\left(1-\frac{i}{N}\right)^{k}\\
 ...
 & =-\frac{kp^{k-1}\left(i\right)}{N}\left(1+O\left(\frac{p\left(i\right)}{N}\right)\right)\\
 & =-\frac{kp^{k-1}\left(i\right)}{N}+o\left(\frac{e\left(i\right)p^{k-1}\left(i\right)}{N}\right),
\end{align*}
and with $ep^{k}$ denoting the pointwise product $i\mapsto e\left(i\right)p^{k}\left(i\right)$,
we have
\begin{align*}
\Delta\left(ep^{k}\right)\left(i\right) & =\varepsilon^{c}\Delta p^{k-C}\left(i\right)=\varepsilon^{c}\Theta\left(\frac{\left(C-k\right)p^{k-C-1}\left(i\right)}{N}\right)\\
 & =\Theta\left(\frac{\left(C-k\right)e\left(i\right)p^{k-1}\left(i\right)}{N}\right).
\end{align*}
