...
of regular graphs a much stronger phenomenon occurs: there is a sense
in which a random $\left(d_{1}+d_{2}\right)$-regular graph is ``the
same'' as a random $d_{1}$-regular graph combined with a random
$d_{2}$-regular graph (see \cite[Section~9.5]{JLR00}).
